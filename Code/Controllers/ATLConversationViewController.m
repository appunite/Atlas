...
- (void)configureControllerForConversation
{
    ...
    if (self.layerClient.authenticatedUser.userID) [otherParticipantIDs removeObject:self.layerClient.authenticatedUser.userID];
...
{
    NSString *senderName = [[self participantForIdentifier:self.layerClient.authenticatedUser.userID] fullName];
...
- (void)didReceiveTypingIndicator:(NSNotification *)notification
{
    ...
    LYRTypingIndicator *indicator = notification.userInfo[LYRTypingIndicatorObjectUserInfoKey];
    LYRTypingIndicatorAction status = indicator.action;
    NSString *participantID = indicator.sender.userID;
    if (status == LYRTypingIndicatorActionBegin) {
...
- (LYRConversation *)conversationWithParticipants:(NSSet *)participants
{
    ...
    options.deliveryReceiptsEnabled = deliveryReceiptsEnabled;
