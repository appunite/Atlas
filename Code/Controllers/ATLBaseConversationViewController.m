...
- (void)dealloc
{
    [[NSNotificationCenter defaultCenter] removeObserver:self name:UITextViewTextDidBeginEditingNotification object:self.messageInputToolbar.textInputView];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:ATLMessageInputToolbarDidChangeHeightNotification object:self.messageInputToolbar];
